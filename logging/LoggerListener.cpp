...
void LoggerListener::connect(std::shared_ptr<Logger> logger)
{
    if (logger) {
...
void LoggerListener::disconnect(std::shared_ptr<Logger> logger)
{
...
QList<shared_ptr<Logger>> LoggerListener::loggers() const
{
    return m_listening;
}

void LoggerListener::slot_receiveEntry(std::shared_ptr<LogEntry> newEntry,
                                       shared_ptr<Logger> sender)
{
