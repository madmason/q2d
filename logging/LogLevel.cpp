...
QColor LogLevel::fontColor() const
{
    return m_fontColor;
}

QColor LogLevel::backgroundColor() const
{
    return m_backgroundColor;
}

void LogLevel::setFontColor(QColor color)
{
    m_fontColor = color;
}

void LogLevel::setBackgroundColor(QColor color)
{
